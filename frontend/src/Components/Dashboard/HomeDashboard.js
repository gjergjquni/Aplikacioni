...
// Emri i përdoruesit do të vijë nga props
const fallbackName = '';
...
export default function HomeDashboard({ 
  ...
  // Për krahasimin me muajin e kaluar - neutral në nisje
        ...
        <div className="main-content-center">
          <div className="greeting-section">
            <div className="greeting-header">
              <div>
                <h1>Mirë se u riktheve{(loggedInUser?.displayName || fallbackName) ? `, ${loggedInUser.displayName || fallbackName}` : ''}!</h1>
